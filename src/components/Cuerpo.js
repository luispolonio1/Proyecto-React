    ...
    const Formulario = () => {
        Swal.fire({
            ...
            preConfirm: async () => {
                ...
                const Informacion = document.getElementById('swal-input2').value.split('/');
            ...
            <div id="carouselExample" className="carousel slide container col-12 col-lg-6">
                <div className="carousel-inner">
                    <div className="carousel-item active">
                        <img src={hy1} className="d-block w-100" alt="carousel1"/>
                    </div>
                    <div className="carousel-item">
                        <img src={hy2} className="d-block w-100" alt="carousel2"/>
                    </div>
                    <div className="carousel-item">
                        <img src={hy3} className="d-block w-100" alt="carousel3"/>
                    </div>
                </div>
